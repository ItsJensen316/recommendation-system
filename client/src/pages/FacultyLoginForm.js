  ...
  "signup_questions": {
    ...
    "professional_information": {
      ...
      "designation": {
        "label": "Designation",
        "type": "select",
        "options": ["Professor", "Assistant Professor", "Associate Professor", "Lecturer"],
        "required": true
      },
      "department": {
        "label": "Department",
...
function Profile() {
  ...
  const [paramId, setParamId] = useSearchParams();
console.log(paramId);
          ...
          <div className="w-full">
            {Object.keys(loginDetails.signup_questions).map((section) => (
              <div key={section}>
                ...
                {Object.keys(loginDetails.signup_questions[section]).map((field) =>{
                  // console.log(loginDetails.signup_questions[section][field]);
                 return renderField(section, field, loginDetails.signup_questions[section][field]);
                }
                )}
              </div>
            ))}
